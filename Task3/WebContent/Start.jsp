...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-twothird">
      ...
      <br><br><br>
      <a href="Add.jsp" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Click here to proceed</a>
...
<div class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <div class="w3-twothird">
      ...
      and Firstname.
      <br><br><br>
      <a href="Edit.jsp" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Click here to proceed</a>
      </p>
    </div>
  </div>
</div>
  ...
  <div class="w3-content">
    <div class="w3-twothird">
      ...
      <p class="w3-text-grey">You can delete the record of the employee who has left the company. </p>
    	<br><br><br>
      <a href="Delete.jsp" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Click here to proceed</a>
...
<div class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <div class="w3-twothird">
      ...
      and Firstname.
      <br><br><br>
      <a href="List.jsp" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Click here to proceed</a>
      </p>
    </div>
  </div>
</div>
